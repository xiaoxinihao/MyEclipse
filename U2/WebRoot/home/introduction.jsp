...
<html >
	...
	<head>
		...
		<link type="text/css" href="${url}/css/optstyle.css" rel="stylesheet" />
		...
		<script type="text/javascript" src="${url}/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
		<script type="text/javascript" src="${url}/js/jquery.imagezoom.min.js"></script>
		...
		<div class="am-container header">
			...
			<ul class="message-r">
				...
				<div class="topMessage mini-cart">
					...
					<c:if test="${!empty sessionScope.ShoppingCart}">
						<div class="menu-hd"><a id="mc-menu-hd" href="${url }/home/shoppingcart.jsp" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h"></strong></a></div>
					</c:if>
				</div>
			...
			<div class="nav-table">
				...
				<ol class="am-breadcrumb am-breadcrumb-slash">
					<li><a href="${url }/home/home.jsp">首页</a></li>
					<li><a href="#">分类</a></li>
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="${url}/images/01.jpg" title="pic" />
								</li>
								<li>
									<img src="${url}/images/02.jpg" />
								</li>
								<li>
									<img src="${url}/images/03.jpg" />
								</li>
							</ul>
						</div>
					</section>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="${url}/images/01.jpg"><img src="${url}/images/01_mid.jpg" alt="细节展示放大镜特效" rel="${url}/images/01.jpg" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${url}/images/01_small.jpg" mid="${url}/images/01_mid.jpg" big="${url}/images/01.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${url}/images/02_small.jpg" mid="${url}/images/02_mid.jpg" big="${url}/images/02.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${url}/images/03_small.jpg" mid="${url}/images/03_mid.jpg" big="${url}/images/03.jpg"></a>
									</div>
								</li>
							</ul>
						</div>
					...
					<div class="clearfixRight">
						...
						<div class="pay">
							<div class="pay-opt">
							<a href="${url }/home/home.jsp"><span class="am-icon-home am-icon-fw">首页</span></a>
							...
							<li>
								...
								<li>
									<div class="clearfix tb-btn tb-btn-buy theme-login">
										<a id="LikBuy" title="点此按钮到下一步确认购买信息" href="${url }/home/shoppingcart.jsp">查看购物车</a>
									</div>
								</li>
								<li>
									<div class="clearfix tb-btn tb-btn-basket theme-login">
										<a id="LikBasket" title="加入购物车" href="javascript:addCart(${product.id})"><i></i>加入购物车</a>
									</div>
								</li>
								</div>
							</li>
					    ...
					    <div class="mc"> 
						     <ul>					    
						     	<div class="mt">            
							      ...
							      <li class="first">
							      	<div class="p-img">                    
							      		<a  href="#"> <img class="" src="${url}/images/browse1.jpg"> </a>               
							      	</div>
								...
								<div class="am-tab-panel am-fade am-in am-active">
									...
									<div class="details">
										...
										<div class="twlistNews">
											<img src="${url}/images/tw1.jpg" />
											<img src="${url}/images/tw2.jpg" />
											<img src="${url}/images/tw3.jpg" />
											<img src="${url}/images/tw4.jpg" />
											<img src="${url}/images/tw5.jpg" />
											<img src="${url}/images/tw6.jpg" />
											<img src="${url}/images/tw7.jpg" />
										</div>
									</div>
									<div class="clear"></div>
								...
								<div class="am-tab-panel am-fade">
									...
									<ul class="am-comments-list am-comments-list-flip">
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
												<img class="am-comment-avatar" src="${url}/images/hwbn40x40.jpg" />
												<!-- 评论者头像 -->
											</a>
										...
										<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
											<li>
												<div class="i-pic limit">
													<img src="${url}/images/imgsearch1.jpg" />
